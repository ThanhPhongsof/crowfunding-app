...
const CampaignFeature = () => {
  return (
    <div className="flex flex-col md:flex-row items-center flex-start gap-x-7 w-full max-w-[328px] md:max-w-[595px]  lg:max-w-[850px] xl:max-w-[1048px]">
      <CampaignImage className="h-[210px] md:h-[266px] flex-1 flex-shrink-0"></CampaignImage>
      <div className="my-4 md:my-0 mr-auto md:mr-0 flex-1 max-w-[435px]">
        ...
        <CampaignInfo
          ...
          size="big"
        ></CampaignInfo>
        <div className="w-full h-[5px] bg-[#EFEFEF] dark:bg-darkStroke rounded-full mb-6">
